const CACHE = "plantogo-shell-v47";
const ASSETS = [
  ...
  "./visibility-fix.css?v=38", "./calendar-insights.css?v=47",
  ...
  "./pwa-install.js?v=31", "./calendar-insights.js?v=47",
  "./trip-calendar-source.js?v=47", "./manifest.json?v=31", "./icons/plantogo-icon.svg"
];
