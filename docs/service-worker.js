const CACHE = "plantogo-shell-v51";
const ASSETS = [
  ...
  "./visibility-fix.css?v=38", "./calendar-insights.css?v=51",
  ...
  "./pwa-install.js?v=31", "./calendar-insights.js?v=51",
  "./trip-calendar-source.js?v=51", "./unified-calendar-occurrences.js?v=51",
