const CACHE = "plantogo-shell-v46";
const ASSETS = [
  ...
  "./visibility-fix.css?v=38", "./calendar-insights.css?v=46",
  ...
  "./pwa-install.js?v=31", "./calendar-insights.js?v=46",
  "./trip-calendar-source.js?v=46", "./manifest.json?v=31", "./icons/plantogo-icon.svg"
];
